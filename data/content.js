const sq = {
  ui: {
    ...
    newsletterSub: 'Merr çdo mëngjes përmbledhjen elegante të lajmeve — kurated by Aurora Lumina.',
    ...
    footerRights: '© 2026 Aurora Lumina — Gazeta e Aurora Sallahu. Të gjitha të drejtat e rezervuara.',
    footerMotto: '"Si aurora, ndriçojmë çdo agim."',
    searchAria: 'Kërko',
    menuAria: 'Meny',
    liveBadge: 'LIVE',
    liveTitle: 'Aurora Lumina Live',
...
const en = {
  ui: {
    ...
    newsletterSub: 'Get an elegant morning roundup of the news — curated by Aurora Lumina.',
    ...
    footerTerms: 'Terms',
    footerCookies: 'Cookies',
    footerRights: '© 2026 Aurora Lumina — Aurora Sallahu\'s Newspaper. All rights reserved.',
...
const live = {
  ...
  viewers: 1847,
  currentShow: {
    sq: 'Lajmet e Mbrëmjes me Aurora Sallahu',
    en: 'Evening News with Aurora Sallahu'
  },
  schedule: [
